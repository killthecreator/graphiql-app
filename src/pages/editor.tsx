...
const Editor: NextPage = () => {
  ...
  return (
    <>
      ...
      <section className="error-wrapper absolute">{error.isError && <Error />}</section>
      <section className="flex h-full w-full grow">
        ...
        <article className="flex w-6/12 flex-col">
          ...
          {schema.isSchema && (
            <Card className="m-1 max-h-screen overflow-y-scroll">
              <CardHeader>
